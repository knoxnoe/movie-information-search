<template>
    <div class="concern">
      <div class="recommandUser">
        ...
        <h2>与你匹配率较高的用户</h2>
        <el-row>
            <el-col class="noe_card_recommd" :span="3" v-for="(o, index) in recommends" :key="index" :offset="index%6 == 0 ? 0 : 1">
      ...
      <div class="followUser">
        <h2>我关注的用户</h2>
        <el-row>
            <el-col class="noe_card_follow" :span="4" v-for="(o, index) in followee" :key="index" :offset="index%4 == 0 ? 0 : 2">
                <el-card shadow="hover" :body-style="{ padding: '0px' }">
                  <div class="avatar">
                    <div class="avatar_img">
                      <img src="https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png" class="image">
